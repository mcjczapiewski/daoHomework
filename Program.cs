...
namespace daoHomework
{
    class Program
    {
        static void Main()
        {
            ...
            {
                Console.WriteLine($"Vehicle ID: {vehicle.VehicleID}, Type: {vehicle.VehicleType}, Wheels: {vehicle.WheelsNumber}, Passengers capacity: {vehicle.MaxPassengersNumber}");
            }
            ...
            Console.WriteLine($"Vehicle ID: {vehicleRetrieved.VehicleID}, Type: {vehicleRetrieved.VehicleType}, Wheels: {vehicleRetrieved.WheelsNumber}, Passengers capacity: {vehicleRetrieved.MaxPassengersNumber}");
